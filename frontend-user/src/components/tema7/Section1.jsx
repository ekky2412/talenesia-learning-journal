...
const Section1 = ({ onSectionDataChange }) => {
    const [data, setData] = useState([
        { noTugas: 1, Task: "Tugas 1 - Mengelola Petty Cash", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 2, Task: "Tugas 2 - Menglola Reimbursment", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 3, Task: "Tugas 3 - Membuat Laporan Keuangan Sederhana", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
    ]);
