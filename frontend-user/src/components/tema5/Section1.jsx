...
const Section1 = ({ onSectionDataChange }) => {
    const [data, setData] = useState([
        { noTugas: 1, Task: "Tugas 1 - Mengelola Penjadwalan", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 2, Task: "Tugas 2 - Pengiriman Barang", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 3, Task: "Tugas 3 - Mengelola dan Mengorganisir Rapat", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 4, Task: "Tugas 4 - Mengelola dan Mempersiapkan Perjalanan", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
    ]);
