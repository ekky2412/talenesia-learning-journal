...
const Section1 = ({ onSectionDataChange }) => {
    const [data, setData] = useState([
        { noTugas: 1, Task: "Tugas 1 - Seputar Rekrutmen", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 2, Task: "Tugas 2 - Membantu Kegiatan HR", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
    ]);
