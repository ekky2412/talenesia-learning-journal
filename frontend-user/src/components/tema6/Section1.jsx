...
const Section1 = ({ onSectionDataChange }) => {
    const [data, setData] = useState([
        { noTugas: 1, Task: "Tugas 1 - Pencatatan Fasilitas Kantor", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 2, Task: "Tugas 2 - Pemeliharaan Fasilitas Kantor", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 3, Task: "Tugas 3 - Mengubah Office Supply", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
        { noTugas: 4, Task: "Tugas 4 - Peminjaman / Penggunaan / Pengembalian Barang Kantor", sedangDikerjakan: false, sudahDikumpulkan: false, masukan: '' },
    ]);
