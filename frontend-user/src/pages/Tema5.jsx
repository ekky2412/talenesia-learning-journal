...
const Tema5 = (props) => {
    ...
    switch (section) {
        ...
        case 12:
            return (
                <Template section={section} setSection={setSection} navigate={navigate} themeid={props.themeid} username={props.username} sectionData={sectionData}>
                    <Section12 onSectionDataChange={handleSectionData} />
                </Template>
            )
        case 13:
            return (
                <Template section={section} setSection={setSection} navigate={navigate} themeid={props.themeid} username={props.username} sectionData={sectionData}>
                    <Section13 onSectionDataChange={handleSectionData} />
                </Template>
            )
        case 14:
            return (
                <Template section={section} setSection={setSection} navigate={navigate} themeid={props.themeid} username={props.username} sectionData={sectionData}>
                    <Section14 onSectionDataChange={handleSectionData} />
                </Template>
            )
        case 15:
            return (
                <Template section={section} setSection={setSection} navigate={navigate} themeid={props.themeid} username={props.username} sectionData={sectionData}>
                    <Section15 onSectionDataChange={handleSectionData} />
                </Template>
            )
    }
}
